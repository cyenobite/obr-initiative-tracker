...
Disclaimer: This project is meant mostly to teach myself "vibe coding" using Claude AI. 
...
Note: Many characters have an init modifier, Each randomly generated number can be modified manually by clicking on the initiate stat and changing it.
...
At the moment I'm unsure if this feature is working correctly. I'm told on the Discord that this audio feature may never work because of browser limitations.
...
This is a work in progress - on pause - as of 7-30-26. 
